...
namespace LiteMath
{
  ...
  static inline uint4 &operator*=(uint4 &a, const uint4 b)
  {
    a.x *= b.x;
    a.y *= b.y;
    a.z *= b.z;
  ...
  static inline uint4 &operator*=(uint4 &a, uint b)
  {
    a.x *= b;
    a.y *= b;
    a.z *= b;
  ...
  static inline int4 &operator*=(int4 &a, const int4 b)
  {
    a.x *= b.x;
    a.y *= b.y;
    a.z *= b.z;
  ...
  static inline int4 &operator*=(int4 &a, int b)
  {
    a.x *= b;
    a.y *= b;
    a.z *= b;
  ...
  static inline float4 normalize(const float4 a)
  {
    float lenInv = float(1) / length(a);
    return a * lenInv;
  }
  ...
  static inline float4 dot3v(const float4 a, const float4 b)
  {
    float res = dot3(a, b);
    return float4(res);
  }
  static inline float4 dot4v(const float4 a, const float4 b)
  {
    float res = dot(a, b);
    return float4(res);
  }
  ...
  static inline float4 length3v(const float4 a)
  {
    float res = std::sqrt(dot3(a, a));
    return float4(res);
  }
  static inline float4 length4v(const float4 a)
  {
    float res = std::sqrt(dot4(a, a));
    return float4(res);
  }
  static inline float4 normalize3(const float4 a)
  {
    float lenInv = float(1) / length3(a);
    return a * lenInv;
  }
  ...
  static inline uint3 &operator*=(uint3 &a, const uint3 b)
  {
    a.x *= b.x;
    a.y *= b.y;
    a.z *= b.z;
  ...
  static inline uint3 &operator*=(uint3 &a, uint b)
  {
    a.x *= b;
    a.y *= b;
    a.z *= b;
  ...
  static inline int3 &operator*=(int3 &a, const int3 b)
  {
    a.x *= b.x;
    a.y *= b.y;
    a.z *= b.z;
  ...
  static inline int3 &operator*=(int3 &a, int b)
  {
    a.x *= b;
    a.y *= b;
    a.z *= b;
  ...
  static inline float3 normalize(const float3 a)
  {
    float lenInv = float(1) / length(a);
    return a * lenInv;
  }
  ...
  static inline uint2 &operator*=(uint2 &a, const uint2 b)
  {
    a.x *= b.x;
    a.y *= b.y;
    return a;
  ...
  static inline uint2 &operator*=(uint2 &a, uint b)
  {
    a.x *= b;
    a.y *= b;
    return a;
  ...
  static inline int2 &operator*=(int2 &a, const int2 b)
  {
    a.x *= b.x;
    a.y *= b.y;
    return a;
  ...
  static inline int2 &operator*=(int2 &a, int b)
  {
    a.x *= b;
    a.y *= b;
    return a;
  ...
  static inline float4 as_float32(const uint4 a)
  {
    float4 res;
    memcpy((char*)&res, (char*)&a, sizeof(uint) * 4);
    return res;
  }


  static inline float4 to_float32(const int4 a) { return float4{ float(a.x), float(a.y), float(a.z), float(a.w) }; }
  static inline float4 as_float32(const int4 a)
  {
    float4 res;
    memcpy((char*)&res, (char*)&a, sizeof(uint) * 4);
    return res;
  ...
  static inline int4 as_int32(const float4 a)
  {
    int4 res;
    memcpy((char*)&res, (char*)&a, sizeof(int) * 4);
    return res;
  }
  static inline uint4 as_uint32(const float4 a)
  {
    uint4 res;
    memcpy((char*)&res, (char*)&a, sizeof(uint) * 4);
    return res;
  ...
  static inline float3 as_float32(const uint3 a)
  {
    float3 res;
    memcpy((char*)&res, (char*)&a, sizeof(uint) * 3);
    return res;
  }


  static inline float3 to_float32(const int3 a) { return float3{ float(a.x), float(a.y), float(a.z) }; }
  static inline float3 as_float32(const int3 a)
  {
    float3 res;
    memcpy((char*)&res, (char*)&a, sizeof(uint) * 3);
    return res;
  ...
  static inline int3 as_int32(const float3 a)
  {
    int3 res;
    memcpy((char*)&res, (char*)&a, sizeof(int) * 3);
    return res;
  }
  static inline uint3 as_uint32(const float3 a)
  {
    uint3 res;
    memcpy((char*)&res, (char*)&a, sizeof(uint) * 3);
    return res;
  ...
  static inline float2 as_float32(const uint2 a)
  {
    float2 res;
    memcpy((char*)&res, (char*)&a, sizeof(uint) * 2);
    return res;
  }


  static inline float2 to_float32(const int2 a) { return float2{ float(a.x), float(a.y) }; }
  static inline float2 as_float32(const int2 a)
  {
    float2 res;
    memcpy((char*)&res, (char*)&a, sizeof(uint) * 2);
    return res;
  ...
  static inline int2 as_int32(const float2 a)
  {
    int2 res;
    memcpy((char*)&res, (char*)&a, sizeof(int) * 2);
    return res;
  }
  static inline uint2 as_uint32(const float2 a)
  {
    uint2 res;
    memcpy((char*)&res, (char*)&a, sizeof(uint) * 2);
    return res;
  ...
  */
  struct float4x4
  {
    ...
    inline explicit float4x4(float A0, float A1, float A2, float A3, float A4, float A5, float A6, float A7, float A8, float A9, float A10, float A11, float A12, float A13, float A14, float A15)
    {
  ...
  static inline float4x4 lookAt(float3 eye, float3 center, float3 up)
  {
    ...
    M.set_col(3, float4{ -x.x * eye.x - x.y * eye.y - x.z * eye.z, -y.x * eye.x - y.y * eye.y - y.z * eye.z, -z.x * eye.x - z.y * eye.y - z.z * eye.z, 1.0f });
    return M;
  }
  ...
  */
  inline Box4f BoxBoxOverlap(const Box4f &box1, const Box4f &box2)
  {
    ...
    {// #TODO: unroll loop and vectorize code
      // sort boxes by min
